...
albu_train_transforms1 = [
    ...
    dict(type="Cutout", num_holes=10, max_h_size=51, max_w_size=51, p=0.25),
...
# load_from = "/opt/ml/code/mmdetection_trash/.pretrained/cascade_mask_rcnn_swin_base_patch4_window7.pth"
...
# runtime settings
evaluation = dict(interval=3, metric="bbox", save_best="bbox_mAP_50")
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project="trash-recycling-object-detection", name="swim_b_retrain_real"
            ),
        ),
    ],
)
